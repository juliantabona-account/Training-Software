                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type = "text" class="form-control res-text-9 res-text-sm-9 res-text-md-9" name = "course-title" placeholder = "Enter course title" required />
                                    </div>
                                    <div class="form-group">
                                        <textarea id = "course-description" class="form-control res-text-9 res-text-sm-9 res-text-md-9" name = "course-overview" rows="4" placeholder = "Enter course description" required></textarea>
                                    </div>
                                    <div class="form-group">
