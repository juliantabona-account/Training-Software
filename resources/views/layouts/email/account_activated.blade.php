...
<head>
	...
	<title>{{ $user->first_name }} - Activate Account</title>
</head>
<body>
	<!--[if mso]>
		<style type="text/css">
												...
												<tr>
													<td>
														...
														<p style="font-size: 17px; padding-right: 30px; padding-left: 30px;">
															Hi {{ $user->first_name }}, Great news! We managed to activate your account. Now its time to 
														...
														<div style="padding-right: 30px; padding-left: 30px; margin-bottom: 40px;">
															<a href="{{ env('APP_DOMAIN') }}/login" class="sm_auto_width sm_block button_link" 
