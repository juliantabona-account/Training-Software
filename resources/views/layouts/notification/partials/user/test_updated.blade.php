<li class="notification alert alert-info">
    <div class="media">
      ...
      <div class="media-body">
        <p class="notification-desc res-text-9">The test <a href = "#" class = "text-primary"><u>"{{ str_replace('"', "", str_limit($notification->data['test']['title'])) }}"</u></a> has been successfully updated!</p>
