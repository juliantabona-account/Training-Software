<li class="notification alert alert-info">
    <div class="media">
      ...
      <div class="media-body">
        <p class="notification-desc res-text-9">The lesson <a href = "#" class = "text-primary"><u>"{{ str_limit($notification->data['lesson']['title']) }}"</u></a> has been successfully trashed! <a href = "#" class = "text-primary"><u>Restore course?</u></a></p>
