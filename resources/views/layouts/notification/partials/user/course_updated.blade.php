<li class="notification alert alert-info">
    <div class="media">
      ...
      <div class="media-body">
        <p class="notification-desc res-text-9">The course <a href = "#" class = "text-primary"><u>"{{ str_limit($notification->data['course']['title']) }}"</u></a> has been successfully updated!</p>
