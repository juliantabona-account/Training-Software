<li class="notification alert-info">
    <div class="media">
      ...
      <div class="media-body">
        <p class="notification-desc res-text-9">You successfully passed <a href = "#" class = "text-primary"><u>"{{ str_replace('"', "", str_limit($notification->data['test']['title'])) }}"</u>.</a> <a href = "#" class = "text-primary">View test?</a></p>
