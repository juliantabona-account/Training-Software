<li class="notification alert-info">
    <div class="media">
      ...
      <div class="media-body">
        <p class="notification-desc res-text-9">The course <a href = "#" class = "text-primary"><u>"{{ str_limit($notification->data['course']['title']) }}"</u></a> has been successfully created. <a href = "#" class = "text-primary">Create your first lesson?</a></p>
