                                        ...
                                        <tr>
                                            ...
                                            <td class="desc">
                                                ...
                                                <h4 class = "res-mt-lg-10-1">
                                                    <a href="/courses/1/lessons/1/edit" class="res-text-7">
                                                ...
                                                <div class = "row">
                                                    <div class = "col-lg-6"> 
                                                        <div class="m-t-sm">
                                                            <a href="/courses/1/lessons/1/edit" class="text-muted res-text-lg-9"><i class="fa fa-pencil"></i> Edit</a>
                                                            |
                ...
                <div class="card m-3 mt-4">
                    <div class="card-header">
                        <div class = "row">
                            ...
                            <div class = "col-lg-6"> 
                                <a href = "/courses/1/preview" target="_blank" type="submit" class="btn res-button app-white-btn float-right">
